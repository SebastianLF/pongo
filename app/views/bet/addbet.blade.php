            ...
            <div class="panel-body">
                ...
                <div role="tabpanel" class="">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class=" strong"><a href="#automatique" role="tab" data-toggle="tab">AUTOMATIQUE</a>
                        </li>
                        <li role="presentation" class="active strong"><a href="#manuel" role="tab" data-toggle="tab">MANUEL</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class=" wrapbetscontainer">
                                    ...
                                    <div class="wrapbet">
                                        <ul class="betheader tablebet">
                                            ...
                                            <li>
                                                <button class="btn btn-danger btn-xs supprbet"><span
                                    ...
                                    <button class="btn btn-default center-block" id="validationbouton"><span
                                                class="glyphicon glyphicon-ok"></span>valider la selection
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-default">
                            <div class="bcggrey panel-body ">
                                ...
                                <div class="row ">
                                    ...
                                    <input id="stakeunitamountinputdashboard" name="stakeunitamountinputdashboard"
                                           type="hidden"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select id="accountsinputdashboard" name="accountsinputdashboard"
                                                class="form-control" placeholder="ex: Pinnacle#1">
                                            <option></option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-2">
                                        ...
                                        <input id="serieinputdashboard" name="serieinputdashboard" class="form-control"
                                               placeholder="ex: 346">
                                    </div>
                                    <div class="form-group col-md-1">
                                        ...
                                        <select id="letterinputdashboard" name="letterinputdashboard"
                                                class="form-control" placeholder="ex: A">
                                            <option></option>
                                            <option>A</option>
                                            <option>B</option>
                                            <option>C</option>
                                ...
                                <div id="wrapmanubetscontainer">
                                    <table class="tablemanubetlines table table-condensed table-bordered">
                                        ...
                                        <tr class="betline">
                                            ...
                                            <td>
                                                <input id="datematchinputdashboard" name="datematchinputdashboard[]"
                                                       class="form-control" type="date">
                                            </td>
                                            <td>
                                                <div class="input-group">
                                                    <input id="sportinputdashboard" name="sportinputdashboard[]"
                                                           class="form-control">

                                                    <div class="input-group-btn">
                                                        <button id="sportsButtonDashboard" type="button"
                                            ...
                                            <td>
                                                <select id="competitioninputdashboard"
                                                        name="competitioninputdashboard[]" class="form-control">
                                                    <option></option>
                                                    <option>Liga</option>
                                            ...
                                            <td width="200">
                                                <div class="input-group">
                                                    <input type="text" id="equipe2input[]" class="form-control"
                                            ...
                                            <td>
                                                <input id="picknameinputdashboard" name="picknameinputdashboard[]"
                                                       class="form-control" placeholder="ex: OVER 2.5">
                                            </td>
                                            <td>
                                                <input id="oddinputdashboard" name="oddinputdashboard[]"
                                                       class="form-control" placeholder="ex: 1.83">
                                            </td>
                                            <td>
                                        ...
                                        <tr id="addbetbuttontr">
                                            <td>
                                                <button id="addbetbutton" type="button" class="btn btn-default"><span
