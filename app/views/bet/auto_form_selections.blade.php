<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td><span class="bold">Pari:</span>{{' '.$selection->market}}{{' ('.$selection->scope.') '}}<br/><span class="bold">Choix:</span>{{' '.$selection->pick}}<br/><span class="bold">Cote:</span>{{' '.$selection->odd_value}}</td>
            <td></td>
            <td>
