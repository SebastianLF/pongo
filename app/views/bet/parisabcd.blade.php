@if($count_paris_abcd == '0')
    <div class="row">
        <div class="col-lg-4 col-lg-offset-4">
            <span class="glyphicon glyphicon-hand-down"></span> Ajouter un pari martingale à l'aide du formulaire d'ajout
            dans le panneau ci-dessous
        </div>
    </div>
@else
    <table id="parisabcdtable" class="table table-light table-condensed table-hover table-paris">
        <thead>
        <tr class="uppercase">
            <th>date</th>
            <th>Sport</th>
