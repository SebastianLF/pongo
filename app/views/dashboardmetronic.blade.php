...
<head>
    ...
    {{ HTML::style('css/twitter-typeahead.css') }}
    <!-- END THEME STYLES -->
        ...
        <div class="container-fluid">
            ...
            <div class="page-logo">
                <a href="{{url('dashboard')}}"><img
                            src="{{asset('metronic_v3.6.2/theme/assets/admin/layout3/img/logo-default.png')}}"
            ...
            <div class="row pull-right">
                <div class="pull-right">
                    ...
                    <div class="uppercase font-hg theme-font">
                        13,760 <span class="font-lg theme-font">{{$user->devise}}</span>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript"
        src="{{asset('metronic_v3.6.2/theme/assets/global/plugins/select2/select2.min.js')}}"></script>
<script type="text/javascript"
