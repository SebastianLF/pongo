                    ...
                    <div class="portlet-body">
                        ...
                        <div class="panel-group accordion" id="">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#" href="#collapse_1" aria-expanded="false"> Formulaire <button type="button" class="btn green btn-sm"><span class="glyphicon glyphicon-refresh glyphicon-spin"></span> Rafrai. selections</button></a>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle accordion-toggle-styled collapsed" data-toggle="collapse" data-parent="#" href="#collapse_2" aria-expanded="false"> Selections</a>
                                    </h4>
                                </div>
                                            ...
                                            <div class="col-md-10 col-sm-9 col-xs-9">
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active fade in" id="tab_manuel">
                                                        ...
                                                        <form method="POST" action="http://localhost/slfweb/public/coupon" accept-charset="UTF-8" id="manualselectionform-add" role="form"><input name="_token" type="hidden" value="qpkdNBplCtRZlSHDYcXmNyFZY6h7pVF7eV9tNLkP">
                                                            <div class="row">
                                    ...
                                    <div class="col-md-2 col-sm-3 col-xs-3">
                                        <ul class="nav nav-tabs tabs-left">
                                            ...
                                            <li style="float: right"><a id="refresh-panier-selection-on-click" type="button"> <span
                                                            class="glyphicon glyphicon-refresh glyphicon-spin"></span>Rafraichir
                                                    panier</a>
                                            </li>
                                        </ul>
                                    </div>
