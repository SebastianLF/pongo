                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-md-8 " style="min-height: 95px">
                                        <div style="margin-bottom: 10px;">
                                            <button id="refresh-panier-selection-on-click" type="button"
                                                    class="btn green btn-sm"><span
                                                        class="glyphicon glyphicon-refresh glyphicon-spin"></span>
                                                Rafraichir
                                            </button>
                                            <span class="font-red-sunglo" style="font-size:11px !important;"><span
                                                        class="glyphicon glyphicon glyphicon-exclamation-sign"></span> Pour voir apparaitre les nouvelles sélections ajoutées à partir du mode auto, veuillez cliquer sur ce bouton.</span>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2 col-sm-3 col-xs-3">
                                            <ul class="nav nav-tabs tabs-left">
                                                ...
                                                <li style="float: right"><a id="refresh-panier-selection-on-click"
                                                                            type="button"> </a>
                                                </li>
                                            </ul>
                                        </div>
                                                ...
                                                <div class="tab-pane active fade in" id="tab_manuel"
                                                    ...
                                                    <form method="POST" action="{{url('coupon')}}"
                                                          ...
                                                          role="form"><input name="_token" type="hidden"
                                                                             value="qpkdNBplCtRZlSHDYcXmNyFZY6h7pVF7eV9tNLkP">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div id="odd_doubleParam2_container" class="col-md-2">
                                                                    ...
                                                                    <select name="odd_doubleParam2"
                                                                            class="form-control input-sm"></select>
                                                                    <span id="odd_doubleParam2_error"
                                                                          class="help-block"></span>
                                                                </div>
                                                                ...
                                                                <div id="odd_doubleParam3_container" class="col-md-2">
                                                                    ...
                                                                    <select name="odd_doubleParam3"
                                                                            class="form-control input-sm"></select>
                                                                    <span id="odd_doubleParam3_error"
                                                                          class="help-block"></span>
                                                                </div>

                                                                <div id="odd_participantParameterName_container"
                                                                     class="col-md-2">
                                                            ...
                                                            <div class="row">
                                                                <div id="liveContainer"
                                                                    ...
                                                                    <label class="checkbox-inline">
                                                                        <div class="checker" id="uniform-live">
                                                                            <span><input type="checkbox" id="live"
                                                                                         value="live"></span></div>
                                                                        live
                                                                    </label>
                                                                </div>
                    ...
                    <div class="caption caption-md col-md-3">
                        <i class="icon-bar-chart theme-font hide"></i>
                                <span class="caption-subject theme-font bold uppercase"><span
                                            class="glyphicon glyphicon-user"></span> Relevé</span>
                    </div>
