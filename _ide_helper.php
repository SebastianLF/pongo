...
namespace {
    ...
    class Cache extends \Illuminate\Support\Facades\Cache{
        ...
        /**
         * Remove all items.blade.php from the cache.
         *
         * @return void 
         * @static 
         */
    ...
    class Config extends \Illuminate\Support\Facades\Config{
        ...
        /**
         * Get all of the configuration items.blade.php.
         *
         * @return array 
         * @static 
         */
    ...
    class HTML extends \Illuminate\Support\Facades\HTML{
        ...
        /**
         * Generate an ordered list of items.blade.php.
         *
         * @param array $list
         * @param array $attributes
         * @return string 
        ...
        /**
         * Generate an un-ordered list of items.blade.php.
         *
         * @param array $list
         * @param array $attributes
         * @return string 
    ...
    class Input extends \Illuminate\Support\Facades\Input{
        ...
        /**
         * Get a subset of the items.blade.php from the input data.
         *
         * @param array $keys
         * @return array 
         * @static 
        ...
        /**
         * Get all of the input except for a specified array of items.blade.php.
         *
         * @param array $keys
         * @return array 
         * @static 
    ...
    class Session extends \Illuminate\Support\Facades\Session{
        ...
        /**
         * Remove all of the items.blade.php from the session.
         *
         * @return void 
         * @static 
         */
