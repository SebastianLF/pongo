...
Thanks for purchasing Metronic 3.6.2 and joining our awesome community! Start browsing the theme just open start.html in your browser.
...
AngularJS Version:
Each admin theme(admin1, admin2, admin3 & admin4) comes with AngularJS version. To learn more go to link "AngularJS Version" in the main menu.
